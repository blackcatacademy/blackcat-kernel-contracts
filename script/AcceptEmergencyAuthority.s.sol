...
/// @notice Accept a pending emergency authority transfer.
/// @dev Must be executed by `pendingEmergencyAuthority`.
///
/// Env:
/// - `PRIVATE_KEY`
/// - `BLACKCAT_INSTANCE_CONTROLLER`
contract AcceptEmergencyAuthority {
    ...
    function run() external {
        ...
        InstanceController(controller).acceptEmergencyAuthority();
        vm.stopBroadcast();
    }
}
