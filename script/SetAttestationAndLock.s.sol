...
/// @notice Set an attestation and immediately lock its key (write-once).
...
contract SetAttestationAndLock {
    ...
    function run() external {
        ...
        InstanceController(controller).setAttestationAndLock(key, value);
        vm.stopBroadcast();
    }
}
