...
contract LockCompatibilityWindow {
    ...
    function run() external {
        ...
        InstanceController(controller).lockCompatibilityWindow();
        vm.stopBroadcast();
    }
}
