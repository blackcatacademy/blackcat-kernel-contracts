...
/// @notice Accept a pending upgrade authority transfer.
/// @dev Must be executed by `pendingUpgradeAuthority`.
///
/// Env:
/// - `PRIVATE_KEY`
/// - `BLACKCAT_INSTANCE_CONTROLLER`
contract AcceptUpgradeAuthority {
    ...
    function run() external {
        ...
        InstanceController(controller).acceptUpgradeAuthority();
        vm.stopBroadcast();
    }
}
