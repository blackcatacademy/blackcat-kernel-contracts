...
contract LockExpectedComponentId {
    ...
    function run() external {
        ...
        InstanceController(controller).lockExpectedComponentId();
        vm.stopBroadcast();
    }
}
