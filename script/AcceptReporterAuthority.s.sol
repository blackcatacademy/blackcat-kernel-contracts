...
/// @notice Accept a pending reporter authority transfer.
/// @dev Must be executed by `pendingReporterAuthority`.
///
/// Env:
/// - `PRIVATE_KEY`
/// - `BLACKCAT_INSTANCE_CONTROLLER`
contract AcceptReporterAuthority {
    ...
    function run() external {
        ...
        InstanceController(controller).acceptReporterAuthority();
        vm.stopBroadcast();
    }
}
