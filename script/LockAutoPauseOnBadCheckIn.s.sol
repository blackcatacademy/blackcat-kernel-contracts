...
contract LockAutoPauseOnBadCheckIn {
    ...
    function run() external {
        ...
        InstanceController(controller).lockAutoPauseOnBadCheckIn();
        vm.stopBroadcast();
    }
}
