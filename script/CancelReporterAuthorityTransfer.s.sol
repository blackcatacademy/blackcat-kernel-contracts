...
/// @notice Cancel a pending reporter authority transfer.
/// @dev Must be executed by `rootAuthority`.
///
/// Env:
/// - `PRIVATE_KEY`
/// - `BLACKCAT_INSTANCE_CONTROLLER`
contract CancelReporterAuthorityTransfer {
    ...
    function run() external {
        ...
        InstanceController(controller).cancelReporterAuthorityTransfer();
        vm.stopBroadcast();
    }
}
